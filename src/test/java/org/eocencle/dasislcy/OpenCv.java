...
public class OpenCv {
    ...
    public static void main(String []args) {
        String sheet = "E:\\practice\\java\\opencv-master\\img\\A4.jpg";

        //A4 二值化膨胀后生成的图片路径
        String results = "E:\\practice\\java\\opencv-master\\img\\card.jpg";
    ...
    public static void Canny(String oriImg, String dstImg, int threshold) {
        ...
        Imgcodecs.imwrite("E:/enresults.jpg", srcImage4);
